    ...
    if ($templateManager) {
        ...
        $mockTemplates = [
            [
                ...
                'description' => 'Complete business dashboard template with modern design and responsive layout for professional websites',
                'price' => 89,
                'preview_image' => 'https://readdy.ai/api/search-image?query=modern%20business%20website%20template%20professional%20corporate%20design%20clean%20interface%20white%20background%20dashboard%20layout&width=350&height=250&seq=wt1&orientation=landscape',
                'seller_name' => 'Alex Johnson',
                'profile_image' => 'https://readdy.ai/api/search-image?query=professional%20designer%20avatar%20headshot%20clean%20background%20modern%20style&width=24&height=24&seq=seller1&orientation=squarish',
                'avg_rating' => 4.9,
                'review_count' => 127,
            ...
            [
                ...
                'description' => 'Full-featured e-commerce template with cart, checkout, admin panel and payment integration',
                'price' => 129,
                'preview_image' => 'https://readdy.ai/api/search-image?query=e-commerce%20website%20template%20online%20shopping%20interface%20modern%20design%20clean%20layout%20white%20background%20product%20showcase&width=350&height=250&seq=wt2&orientation=landscape',
                'seller_name' => 'Sarah Chen',
                'profile_image' => 'https://readdy.ai/api/search-image?query=female%20designer%20avatar%20headshot%20professional%20clean%20background%20modern%20style&width=24&height=24&seq=seller2&orientation=squarish',
                'avg_rating' => 4.8,
                'review_count' => 289,
                'downloads_count' => 2156,
                'technology' => 'Vue.js',
                'tags' => '["Vue.js", "E-commerce", "Shopping"]',
                'is_featured' => true,
        ...
        echo json_encode([
            ...
            'pagination' => [
                'current_page' => 1,
                'total_pages' => 1,
                'total_count' => count($mockTemplates),
                'per_page' => 12
            ]
        ]);
    }
...
// Get initial data for page load (fallback to mock data)
if ($templateManager) {
    $templates = $templateManager->getTemplates([], 'popular', 12);
    $totalCount = $templateManager->getTotalCount(); // Get total count from database
    ...
    $templates = [
        ...
        [
            ...
            'description' => 'Stunning portfolio template for creative professionals, agencies and freelancers with gallery features',
            'price' => 49,
            'preview_image' => 'https://readdy.ai/api/search-image?query=creative%20portfolio%20website%20template%20modern%20design%20artistic%20layout%20clean%20interface%20white%20background%20showcase%20gallery&width=350&height=250&seq=wt3&orientation=landscape',
            'seller_name' => 'Mike Rodriguez',
            'profile_image' => 'https://readdy.ai/api/search-image?query=creative%20designer%20avatar%20headshot%20artistic%20background%20modern%20style&width=24&height=24&seq=seller3&orientation=squarish',
            'avg_rating' => 5.0,
            'review_count' => 203,
            'downloads_count' => 876,
            'technology' => 'HTML',
            'tags' => '["HTML", "Portfolio", "Creative"]',
            'is_featured' => false,
    ...
    $categories = [
        ['name' => 'All Templates', 'slug' => 'all', 'template_count' => 6],
        ['name' => 'Admin Dashboard', 'slug' => 'admin', 'template_count' => 0],
        ['name' => 'Business', 'slug' => 'business', 'template_count' => 3],
        ['name' => 'E-commerce', 'slug' => 'ecommerce', 'template_count' => 1],
        ['name' => 'Landing Page', 'slug' => 'landing', 'template_count' => 1],
        ['name' => 'Portfolio', 'slug' => 'portfolio', 'template_count' => 1]
    ];
    
    $technologies = [
        ['technology' => 'React', 'count' => 2],
        ['technology' => 'HTML', 'count' => 1],
        ['technology' => 'WordPress', 'count' => 1],
        ['technology' => 'Vue.js', 'count' => 1],
        ['technology' => 'Figma', 'count' => 1]
    ];
}
?>
<!DOCTYPE html>
                ...
                <div class="lg:col-span-3">
                    ...
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
                        <div class="flex items-center space-x-4">
                            ...
                            <div class="flex items-center space-x-2">
                                <button class="w-8 h-8 flex items-center justify-center bg-primary text-white rounded-button">
                                    <i class="ri-grid-line text-sm"></i>
                                </button>
                                <button class="w-8 h-8 flex items-center justify-center bg-white/80 text-gray-600 rounded-button hover:bg-gray-100 transition-colors">
