-- Orbix Market Database Schema
-- Create database and tables for the marketplace

CREATE DATABASE IF NOT EXISTS orbix_market;
USE orbix_market;
...
('Custom Design', 'Get a unique website designed specifically for your brand and requirements', 299.00, 'ri-palette-line'),
('HTML Slicing', 'Convert your Figma or PSD designs into pixel-perfect HTML/CSS code', 149.00, 'ri-code-line'),
('Template Customization', 'Modify existing templates to match your brand colors and content', 99.00, 'ri-tools-line'),
('SEO Optimization', 'Optimize your website for search engines and improve performance', 199.00, 'ri-search-line');

-- Insert sample users (sellers)
INSERT INTO users (username, email, password_hash, first_name, last_name, profile_image, user_type, is_verified) VALUES
...
INSERT INTO templates (title, slug, description, price, category_id, seller_id, preview_image, demo_url, technology, tags, downloads_count, views_count, rating, reviews_count, is_featured, status) VALUES
...
INSERT INTO reviews (template_id, user_id, rating, review_text) VALUES
...
CREATE INDEX idx_templates_seller ON templates(seller_id);
